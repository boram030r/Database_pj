...
--------------------------------------------------------
--  DDL for Sequence SEQ_FAVORITES
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."SEQ_FAVORITES"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence SEQ_MOVIEREVIEW
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."SEQ_MOVIEREVIEW"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."COUNTRIES" 
   (	"COUNTRY_ID" CHAR(2 BYTE), 
	"COUNTRY_NAME" VARCHAR2(40 BYTE) DEFAULT null, 
	"REGION_ID" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."DEPARTMENT" 
   (	"DEPTNO" NUMBER(2,0), 
	...
	"DEPARTMENT_ID" VARCHAR2(15 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."DEPARTMENTS" 
   (	"JOB_ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."MEMBER" 
   (	"USERID" VARCHAR2(20 BYTE), 
	...
	"FAVORITEGENRE" VARCHAR2(30 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  ...
  TABLESPACE "SYSTEM" ;
   ...
   COMMENT ON COLUMN "SYSTEM"."MEMBER"."USERID" IS '유저 아이디';
   COMMENT ON COLUMN "SYSTEM"."MEMBER"."PASSWORD" IS '패스워드';
   COMMENT ON COLUMN "SYSTEM"."MEMBER"."NAME" IS '이름';
   COMMENT ON COLUMN "SYSTEM"."MEMBER"."FAVORITEGENRE" IS '좋아하는 장르';
--------------------------------------------------------
--  DDL for Table MOVIEREVIEW
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."MOVIEREVIEW" 
   (	"REVIEWID" NUMBER(*,0), 
	"USERID" VARCHAR2(20 BYTE), 
	"MOVIEID" NUMBER(*,0), 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table MOVIESINFO
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."MOVIESINFO" 
   (	"MOVIEID" NUMBER(*,0), 
	"TITLE" VARCHAR2(100 BYTE), 
	"GENRE" VARCHAR2(20 BYTE), 
	"ACTORS" VARCHAR2(255 BYTE), 
	"DIRECTOR" VARCHAR2(100 BYTE), 
	"PLOT" VARCHAR2(500 BYTE), 
	"RELEASEYEAR" NUMBER(*,0), 
	"RELEASEMONTH" NUMBER(*,0), 
	"RELEASEDAY" NUMBER(*,0), 
	"RATING" NUMBER(3,1)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
...
--------------------------------------------------------
--  DDL for Table PEOPLE_IMPORMATION
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."PEOPLE_IMPORMATION" 
   (	"PEOPLE_NAME" VARCHAR2(20 BYTE), 
	"PEOPLE_PHONENUMBER" VARCHAR2(20 BYTE), 
	"PEOPLE_EMAIL" VARCHAR2(30 BYTE), 
	"STUDENT_NUMBER" NUMBER(20,0), 
	"PEOPLE_AGE" NUMBER(10,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."REGIONS" 
   (	"REGION_ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"REGION_NAME" VARCHAR2(25 BYTE) DEFAULT null
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for View EMPVU10
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."EMPVU10" ("EMPLOYEE_ID", "FIRST_NAME") AS 
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.EMP1
SET DEFINE OFF;
REM INSERTING into SYSTEM.FAVORITES
SET DEFINE OFF;
Insert into SYSTEM.FAVORITES (FAVORITEID,USERID,MOVIEID) values (33,'boram12255',1);
Insert into SYSTEM.FAVORITES (FAVORITEID,USERID,MOVIEID) values (34,'boram12255',3);
...
REM INSERTING into SYSTEM.JOBS
SET DEFINE OFF;
...
SET DEFINE OFF;
Insert into SYSTEM.MEMBER (USERID,PASSWORD,NAME,FAVORITEGENRE) values ('boram12255','031225','최보람','애니메이션');
Insert into SYSTEM.MEMBER (USERID,PASSWORD,NAME,FAVORITEGENRE) values ('boram_1225','031225','최보람','애니메이션');
REM INSERTING into SYSTEM.MOVIEREVIEW
SET DEFINE OFF;
Insert into SYSTEM.MOVIEREVIEW (REVIEWID,USERID,MOVIEID,COMM) values (38,'boram12255',1,'재밌어요 !');
REM INSERTING into SYSTEM.MOVIESINFO
SET DEFINE OFF;
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (1,'업','애니메이션','이순재, 에드워드 에스너, 밥 피터슨','피트 닥터','평생 모험을 꿈꿔 왔던 칼 할아버지는 수천 개의 풍선을 매달아 집을 통째로 남아메리카로 날려 버리는데, ‘칼’ 할아버지의 이 위대한 모험에 초대 받지 않은 불청객이 있었으니, 바로 황야의 탐험가 러셀! 그들은 과연 남미의 잃어버린 세계에서 사라져 버린 꿈과 희망,행복을 다시 찾을 수 있을까?',2009,7,29,9.2);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (2,'볼트','애니메이션','존 트라볼타, 마일리 사이러스, 수지 에스먼','바이런 하워드, 크리스 윌리엄스','최고의 TV스타 볼트가 어느 날 우연히 헐리우드 촬영장을 떠나 뉴욕까지 오게 되면서 견생 최대의 도전이 시작된다. 그의 주인이자 연기 파트너인 ‘페니’에게 돌아가려면, 미국 대륙을 가로질러야만 하니까!',2008,12,31,8.9);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (3,'벼랑 위의 포뇨','애니메이션','나라 유리에, 도이 히로키, 야마구치 토모코','미야자키 하야오','엉뚱한 물고기 소녀 포뇨의 사랑을 찾기 위한 좌충우돌 모험이 시작된다! 포뇨는 과연 여러 난관들을 뚫고 소스케를 만날 수 있을까?',2008,12,18,7.9);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (4,'겨울왕국','애니메이션','박지윤, 소연, 박혜나','크리스 벅, 제니퍼 리','서로 최고의 친구였던 자매 엘사와 안나. 모든것을 얼려버리는 힘이 있는 엘사는 힘이 두려워 왕국을 떠나고, 안나는 언니를 찾아 여정을 떠나는데..',2014,1,16,8.3);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (5,'엔칸토:마법의 세계','애니메이션','스테파니 베아트리즈','자레드 부시','놀라운 마법의 세계 엔칸토, 그 중 미라벨은 가족 중 유일하게 아무런 능력이 없다. 마법의 힘이 위험에 처하자 미라벨은 자신이 마지막 희망이라 생각하는데..',2021,11,24,7.8);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (6,'코코','애니메이션','안소니 곤잘레스, 가엘 가르시아베르날','리 언크리치','뮤지션을 꿈꾸는 소년 미구엘은 전설적인 가수 에르네스토의 기타에 손을 댔다 ‘죽은 자들의 세상’에 들어가게 된다. 그리고 그곳에서 만난 의문의 사나이 헥터와 함께 상상조차 못했던 모험을 시작하게 되는데',2018,1,11,9.1);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (7,'신데렐라','애니메이션','제임스 맥도날드, 베르나 펠턴','윌프레드 잭슨, 해밀턴 러스크','새엄마와 언니들의 구박을 받는 신데렐라, 궁정무도회를 참가해 멋진 왕자님을 만나지만 시계가 12시를 지나자 마법을 풀리고 유리구두 한짝을 떨 군 신데렐라.. 왕자님과 만날 수 있을까?',1962,7,26,8.4);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (8,'마녀 배달부 키키','애니메이션','타카야마 미나미, 사쿠마 레이','미야자키 하야오','사랑스러운 초보마녀 ‘키키’는 검은 고양이 ‘지지’와 함께 빗자루를 타고 마녀 수련을 떠난다. 키키의 아주 특별한 마법 같은 모험!',2007,11,22,8.1);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (9,'라푼젤','애니메이션','맨디 무어, 재커리 리바이','네이든 그레노, 바이런 하워드','18년을 탑에서만 지낸 라푼젤, 어느 날 탑에 친입한 그를 때려잡는다. 어쩌다 그와 집밖으로 나와 스릴 넘치는 세상을 즐기는데..',2011,2,10,9);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (10,'이웃집 토토로','애니메이션','히다카 노리코, 사카모토 치카','미야자키 하야오','도시를 떠나 시골로 이사 온 사츠키와 메이는 우연히 토토로를 만나 신비한 모험을 한다. 그러던 어느 날, 메이가 행방불명 되는데..',2001,7,28,9);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (11,'연애 빠진 로맨스','로맨스','전종서, 손석구','정가영','전남친과 격한 이별 후 데이팅 어플로 상대를 검색하는 스물 아홉 자영, 서른셋 우리 둘은 서로에게 급속도로 빠져들게 되고.. ',2021,11,24,7.8);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (12,'로맨스 조','로맨스','김영필, 신동미, 이채은','이광국','스타 감독 이감독은 시골 여관에 갇혀 시나리오를 집힐하게 된다. 우연히 다방 레지에게 러브스토리를 듣게 되는데',2012,3,8,7.7);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (13,'오늘 밤, 로맨스 극장에서','로맨스','아야세 하루카, 사카구치 켄타로','타케우치 히데키','영화감독을 꿈꾸는 켄지, 고전 영화 속 미유키를 동경하는 그는 어느날 공주가 현실 속으로 나타나는데!',2018,7,11,7.6);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (14,'아홉수 로맨스','로맨스','조한나, 이다해, 강나리','이새별, 신효진','서연, 희주, 가희 29살 10년 지기 네 친구들은 모두 연애로 골치다. 우리의 스물아홉수를 위하여!',2021,2,24,4);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (15,'순정만화','로맨스','유지태, 이연희, 채정안','류장하','엘레베이터에서 아래층 여고생과 마쥔 서른 살 연우, 첫 눈에 그녀에게 반해버린 강숙은 열렬한 짝사랑을 시작하는데!',2008,11,27,8.1);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (16,'트와일라잇','로맨스','크리스틴 스튜어트, 로버트 패틴슨','캐서린 하드윅','평범한 고등학생 소녀 벨라는 집안 사정으로 아빠 집으로 이사를 오는데 잘생긴 에드워드와 마주치고 인생의 전환을 맞이한다.',2008,12,10,7.9);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (17,'어쩌다 로맨스','로맨스','레벨 윌슨, 리암 헴스워스','토드 스트라우스슐슨','로맨스 영화를 믿지 않는 건축가. 머리를 다친 후 깨어보니, 로맨틱 코미디의 주인공이 되어 있다. 아름다운 세상이 악몽과도 같은 그녀. 정녕 해피 엔딩은 없는 걸까.',2019,2,13,7.1);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (18,'어바웃 타임','로맨스','도널 글리슨, 레이첼 맥아담스, 빌 나이','리차드 커티스','꿈을 위해 런던으로 간 팀은 우연히 메리에게 첫눈에 반하게 되는데 과연 여러 사건들을 겪고 완벽한 사랑을 할 수 있을까?',2013,12,5,8.6);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (19,'타이타닉','로맨스','레오나르도 디카프리오, 케이트 윈슬렛','제임스 카메론','타이타닉호에 올라탄 잭은 로즈에게 한눈에 반하게 되는데 배가 바닷속으로 침몰하는 사건이 일어난다. 이들은 과연 어떻게 될까?',1998,2,20,9.5);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (20,'하비의 마지막 로맨스','로맨스','더스틴 호프만, 엠마 톰슨','조엘 홉킨스','우울함을 달래러 카페에 들렀다가 우연히 공항에서 일하는 케이트와 이야기를 하게 된 하비, 이 둘은 서로에게 특별한 호감을 느끼는데..',2010,10,28,8.2);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (21,'사채소년','액션','유선호, 강미나, 유인수','황동석','학교 서열 최하위, 고교 사채왕이 되다. 짝사랑하는 다영과 가까워지며 행복한 시간도 잠시, 위협하는 사람들이 나타나기 시작하는데..',2023,11,22,6.6);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (22,'더 마블스','액션','브리 라슨, 티요나 패리스, 이만 벨라니','니아 다코스타','최강 희어로 캡틴 마블 캐럴 댄버스, 빛의 파장을 조장하는 모니카 램보, 열렬한 팬인 카말라 칸, 2023년 캡틴 마블이 돌아온다!',2023,11,8,3.8);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (23,'올드보이','액션','조슈 브롤린, 샬토 코플리','스파이크 리','이유를 알 수 없는 20년의 감금, 놈을 제거하기 위한 사상 최악의 위험한 거래가 시작된다!',2014,1,16,6.1);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (24,'킹스맨:퍼스트 에이전트','액션','랄프 파인즈, 해리스 디킨슨','매튜 본','역사상 최악의 폭군들과 범죄자들이 모여 생명을 윕협할 전쟁을 모의하는 광기의 시대, 이를 막으려는 킹스맨의 최초 미션이 시작된다!',2021,12,22,7);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (25,'존 윅3:파라벨룸','액션','키아누 리브스, 할리 베리','채드 스타헬스키','업계 레전드 킬러 ‘존 윅’은 현상금 1,400만 불로 인해 전 세계의 가장 위협적인 킬러들이 그와의 전쟁을 선포한다.',2019,6,26,6.8);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (26,'범죄도시','액션','마동석, 윤계상, 조재윤','강윤성','통쾌하고! 화끈하고! 살벌하게! 올 추석, 나쁜 놈들 때려잡는 강력반 형사들의 ‘조폭소탕작전’이 시작된다!',2017,10,3,8.3);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (27,'미션 임파서블:폴아웃','액션','톰 크루즈, 헨리 카빌','크리스토버 맥쿼리','에단 헌트는 작전 수행 중 예상치 못한 결단을 내리게 되고, 중앙정보국 CIA는 그를 견제하기 위해 상급 요원 어거스트 워커(헨리 카빌)를 파견한다.
최악의 테러 위기와 라이벌의 출현 속, 팀이 행한 모든 선의의 선택들이 최악의 결과로 돌아오면서 미션은 점점 더 예측할 수 없는 상황으로 치닫게 되는데…
',2018,7,25,8.1);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (28,'트랜스포머3','액션','샤이아 라보프, 로지 헌팅턴휘틀리','마이클 베이','수천 년을 끌어온 오토봇 VS 디셉티콘의 전쟁 그 최후의 전투가 지금 시작된다!',2011,6,29,6.5);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (29,'엑시트','액션','조정석, 윤아, 고두심','이상근','기존 재난영화와는 다른 신선도 100%! 재기 발랄한 재난 탈출 영화가 찾아온다!',2019,7,31,7.7);
Insert into SYSTEM.MOVIESINFO (MOVIEID,TITLE,GENRE,ACTORS,DIRECTOR,PLOT,RELEASEYEAR,RELEASEMONTH,RELEASEDAY,RATING) values (30,'스파이더맨:노 웨이 홈','액션','톰 홀랜드, 젠데이아 콜먼','존 왓츠','‘미스테리오’의 계략으로 세상에 정체가 탄로난
 스파이더맨 ‘피터 파커’는 하루 아침에 평범한 일상을 잃게 된다. 스파이더맨에게 깊은 원한을 가진 숙적들의 강력한 공격에
 ‘피터 파커’는 사상 최악의 위기를 맞게 되는데…',2021,12,15,6.7);
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.PEOPLE_IMPORMATION
SET DEFINE OFF;
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.EMPVU10
SET DEFINE OFF;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."DEPT_DEPTNO_PK" ON "SYSTEM"."DEPT" ("DEPTNO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."EMP_EMPNO_PK" ON "SYSTEM"."EMP" ("EMPNO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008412" ON "SYSTEM"."REGIONS" ("REGION_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008414" ON "SYSTEM"."COUNTRIES" ("COUNTRY_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008418" ON "SYSTEM"."JOBS" ("JOB_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008421" ON "SYSTEM"."DEPARTMENTS" ("JOB_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008466" ON "SYSTEM"."MEMBER" ("USERID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008475" ON "SYSTEM"."MOVIESINFO" ("MOVIEID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008479" ON "SYSTEM"."MOVIEREVIEW" ("REVIEWID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008482" ON "SYSTEM"."FAVORITES" ("FAVORITEID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."COUNTRIES" MODIFY ("REGION_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DEPARTMENTS" MODIFY ("JOB_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DEPARTMENTS" MODIFY ("JOB_TITLE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DEPARTMENTS" ADD PRIMARY KEY ("JOB_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DEPT" ADD CONSTRAINT "DEPT_DEPTNO_PK" PRIMARY KEY ("DEPTNO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."EMP" MODIFY ("DEPTNO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EMP" ADD CONSTRAINT "EMP_EMPNO_PK" PRIMARY KEY ("EMPNO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."EMP1" MODIFY ("ENAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EMP1" MODIFY ("DEPTNO" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table FAVORITES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."FAVORITES" ADD PRIMARY KEY ("FAVORITEID")
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."JOBS" ADD PRIMARY KEY ("JOB_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MEMBER" MODIFY ("FAVORITEGENRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MEMBER" ADD PRIMARY KEY ("USERID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MOVIEREVIEW" ADD PRIMARY KEY ("REVIEWID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table MOVIESINFO
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."MOVIESINFO" MODIFY ("TITLE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MOVIESINFO" ADD PRIMARY KEY ("MOVIEID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."REGIONS" ADD PRIMARY KEY ("REGION_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."COUNTRIES" ADD FOREIGN KEY ("REGION_ID")
	  REFERENCES "SYSTEM"."REGIONS" ("REGION_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table EMP1
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."EMP1" ADD CONSTRAINT "EMP_DEPTNO_FK" FOREIGN KEY ("DEPTNO")
	  REFERENCES "SYSTEM"."DEPT" ("DEPTNO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table MOVIEREVIEW
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."MOVIEREVIEW" ADD FOREIGN KEY ("USERID")
	  REFERENCES "SYSTEM"."MEMBER" ("USERID") ENABLE;
  ALTER TABLE "SYSTEM"."MOVIEREVIEW" ADD FOREIGN KEY ("MOVIEID")
	  REFERENCES "SYSTEM"."MOVIESINFO" ("MOVIEID") ENABLE;
--------------------------------------------------------
